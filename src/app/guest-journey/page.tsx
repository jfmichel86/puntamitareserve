...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.mexicanreserve.com/guest-journey' },
...
export default function GuestJourneyPage() {
  return (
    <>
      {/* The hero photo is set as a plain CSS background (see #gj-hero
      ...
      <section id="gj-hero">
        <p className="pg-eyebrow">The Guest Journey</p>
