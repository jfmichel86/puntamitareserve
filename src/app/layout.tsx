...
// served from our own domain instead of fonts.googleapis.com so the fonts
// always load reliably instead of depending on Google's CDN at runtime.
  ...
  return (
    <html lang="en" className={`${cormorant.variable} ${inter.variable}`}>
      <body>
        ...
        {/* WhatsApp float */}
        <a
          href="https://wa.me/523313619889?text=Hello%2C%20I%27m%20interested%20in%20a%20rental%20in%20Punta%20Mita"
          className="wa" target="_blank" rel="noopener" aria-label="Chat on WhatsApp"
        >
