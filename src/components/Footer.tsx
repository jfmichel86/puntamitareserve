    ...
    <footer>
      <div className="footer-top">
        <div>
          ...
          <p className="ft-tagline">Mexico, reserved for the few — private villas across Punta Mita, Punta de Mita and Puerto Vallarta, with the personal service to make every stay exceptional.</p>
