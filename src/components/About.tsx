    ...
    <section id="about">
      ...
      <div className="about-body">
        <div className="about-text">
          ...
          <p className="s-body">We&rsquo;ve spent years building relationships with property owners in every destination we serve — and with the restaurants, chefs, and experience providers who make a stay memorable. When you book with us, that network is yours.</p>
        ...
        <div>
          ...
          <div className="svc-list">
            {[
              ['Airport transfers', 'Reliable transportation from the airport — door to door from arrival.'],
              ...
              ['Restaurant reservations', 'We secure the tables that are hardest to get, wherever you&rsquo;re staying.'],
            ].map(([name, desc]) => (
