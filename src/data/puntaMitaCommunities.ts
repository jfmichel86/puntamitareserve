...
export const PUNTA_MITA_COMMUNITIES: CommunityGeo[] = [
  ...
  { slug: '7-eight-bahia-golf-residences', name: '7 Eight Bahia', lat: 20.7781, lng: -105.5280, description: 'Low-rise residences on the 7th and 8th fairways of the Bahia course — four-bedroom homes with a private plunge pool on every terrace, an easy walk to Pacífico Beach Club.', sunOrientation: 'none' },
  { slug: 'el-encanto', name: 'El Encanto', lat: 20.7662, lng: -105.5301, description: 'Condos within El Encanto, most looking out over the Pacifico course’s fairways or the community’s lakes rather than the ocean.', sunOrientation: 'none' },
  { slug: 'el-encanto-villas', name: 'El Encanto Villas', lat: 20.7651, lng: -105.5295, description: 'Standalone villas within El Encanto — the community’s only ocean-facing homes, each with a private pool, moments from Sufi Ocean Club.', sunOrientation: 'sunrise' },
  { slug: 'four-seasons-residences', name: 'Four Seasons Residences', lat: 20.7828, lng: -105.5275, description: 'Private villas and residences inside the Four Seasons Resort grounds, with full access to the hotel’s dining, spa, and daily service standards.' },
  { slug: 'hacienda-de-mita', name: 'Hacienda de Mita', lat: 20.7708, lng: -105.5219, description: 'Punta Mita’s only true beachfront condo community — low-rise buildings around a communal infinity pool, with direct beach access and Pacifico fairway views.', sunOrientation: 'sunrise' },
  ...
  { slug: 'kupuri', name: 'Kupuri', lat: 20.7819, lng: -105.5115, description: 'Home sites sold individually across Kupuri — every villa custom-built and different from the next, a short walk from Kupuri Beach Club’s sushi counter, Ka restaurant, and treehouse spa.', sunOrientation: 'sunrise' },
  { slug: 'kupuri-beach-residences', name: 'Kupuri Beach Residences', lat: 20.7803, lng: -105.5086, description: 'A single matched collection of condos within Kupuri, all built to the same design, a short walk from Kupuri Beach Club.', sunOrientation: 'sunrise' },
  { slug: 'la-punta-estates', name: 'La Punta Estates', lat: 20.7599, lng: -105.5348, description: 'Oceanfront lots on the peninsula’s western tip next to the St. Regis, each with 270-degree ocean views and a second, separately gated entrance.', sunOrientation: 'both' },
  ...
  { slug: 'las-marietas', name: 'Las Marietas', lat: 20.7634, lng: -105.5350, description: 'An ultra-private enclave at the peninsula’s edge, named for the Marietas Islands visible from nearly every residence — three- and four-bedroom homes with sweeping sunset ocean views.', sunOrientation: 'sunset' },
  { slug: 'las-palmas', name: 'Las Palmas', lat: 20.7742, lng: -105.5313, description: 'Houses in Las Palmas’ original phase, nearly all facing the golf course — three and four bedroom homes sharing a similar architectural style.', sunOrientation: 'none' },
  ...
  { slug: 'las-terrazas', name: 'Las Terrazas', lat: 20.7732, lng: -105.5258, description: 'A boutique condo community on the Pacifico course’s 14th fairway, centered on twin communal pools linked by a 160-meter saltwater swimming canal.', sunOrientation: 'none' },
  ...
  { slug: 'pacifico-estates', name: 'Pacifico Estates', lat: 20.7710, lng: -105.5374, description: 'West-facing homes near the Pacifico course built for sunset — horizontal architecture and extensive glazing framing the Pacific’s golden hour, moments from Sea Breeze Beach Club.', sunOrientation: 'sunset' },
  { slug: 'porta-fortuna', name: 'Porta Fortuna', lat: 20.7627, lng: -105.5313, description: 'Porta Fortuna’s original ocean-facing villas, in two rows — first-row homes sit beachfront with five real bedrooms, second-row villas hold four bedrooms and their own ocean views, both a short walk from Sufi Ocean Club.', sunOrientation: 'sunrise' },
  ...
  { slug: 'tau-residences', name: 'TAU Residences', lat: 20.7622, lng: -105.5351, description: 'Punta Mita’s newest enclave, at the peninsula’s southern point, built for sunset views with modern, smart-home-equipped three- and four-bedroom residences.', sunOrientation: 'sunset' },
  { slug: 'the-surf-residences', name: 'The Surf Residences', lat: 20.7639, lng: -105.4900, description: 'Condos by architects Sordo Madaleno, set directly in front of the La Lancha surf break with views of the Marietas Islands and Banderas Bay, steps from El Surf Club.', sunOrientation: 'sunset' },
  ...
  { slug: 'bahia-signature-estates', name: 'Bahia Signature Estates', lat: 20.7600, lng: -105.5290, description: 'Estates set between the Bahia fairways and the open Pacific, most with a private infinity pool angled toward the water — no two homes alike.' },
  { slug: 'bellavista-residences', name: 'Bellavista Residences', lat: 20.7695, lng: -105.5370, description: 'Hillside homes above the golf courses, each with floor-to-ceiling glass, a private pool, and sweeping views over the Pacific and both fairways below.' },
  ...
  { slug: 'la-serenata', name: 'La Serenata', lat: 20.7567, lng: -105.5397, description: 'A secluded, quiet enclave with spa-style finishes and generous grounds on three- and four-bedroom homes.' },
